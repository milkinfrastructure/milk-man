...
Analyze only the supplied checkpoint input. Return exactly this JSON object and no prose:
...
Do not choose object keys, scope, provenance, counts, digests, routes, providers, or credentials. Do not repeat conversation text in the output.
