...
- [~] The replacement v16 revision is `852c5d6166fae52c3e49f33b4a161ddf8707b885973576cdd9ab0a26668e552a`, eval UUID `fe738c74-97ec-5afb-a195-ba77962baa4d`. Generation batches are oracle-homogeneous and each shard binds one deterministic schema root type directly in its strict tool definition. The first 256-case shard accepted 224 cases on its initial pass, independently rejected 32 genuinely incorrect cases, repaired only those cases, and became prepared in 22 inference turns; immediate replay made zero calls. The v14 512-case pointer remains visible until the v16 coordinator advances the shared ledger.
